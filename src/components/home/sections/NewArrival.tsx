      ...
      <div className='container pb-8 xl:pb-24'>
        <div ref={glideRef} className='glide relative'>
              ...
              {newArrivalsData.map((newArrival) => (
                ...
                >
                  <div className='absolute left-0 top-0 -z-10 size-full'>
                    <img src={newArrival.image} alt='bg-graphic' className='object-cover h-full' />
                  ...
                  <div className='absolute p-6 text-white lg:bottom-0 lg:w-1/2 lg:p-14'>
                    ...
                    <h4 className='mb-4 text-2xl font-semibold'>{newArrival.title}</h4>
                    <p className='mb-12 w-4/5 text-neutral-300'>{newArrival.content}</p>
                    <ShopNowButton />
                  </div>
                </li>
              ))}
          ...
          <div className='absolute bottom-4 right-1/2 z-10 flex translate-x-1/2 items-center gap-4 text-sm lg:bottom-14 lg:right-14'>
            <div className=' glide__arrows flex items-center gap-2' data-glide-el='controls'>
              <button
                type='button'
