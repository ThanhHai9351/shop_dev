...
import ButtonAddWhistlist from "@/pages/user/products/button-add-whistlist"
...
const SectionProduct = ({ product, fetchDetails }: { product: IProduct; fetchDetails: () => void }) => {
      ...
      <div className='col-span-12 md:col-span-6 lg:col-span-4'>
        ...
        <div className=''>
          ...
          <div className='flex gap-2'>
            <InputNumber defaultValue={quantity} onChange={setQuantity} />
            <ButtonSecondary className='w-full' onClick={addToCart}>
              Add to Cart
            </ButtonSecondary>
            <ButtonAddWhistlist fetchDetails={fetchDetails} productId={product.id} wishlisted={product.wishlisted} />
          </div>
        </div>
