  ...
  const renderContent = () => {
    return (
      <Transition appear show={isVisable} as={Fragment}>
        <Dialog as='div' className='absolute inset-0 top-[117px] z-50 overflow-y-auto' onClose={handleCloseMenu}>
          <div className='z-max absolute inset-y-0 right-0 w-full outline-none focus:outline-none'>
            ...
            >
              <div className='relative z-20 mt-5'>
                <div className='overflow-hidden bg-white shadow-lg ring-1 ring-black/5 dark:bg-neutral-950 p-5'>
                  <div className='container relative w-full py-10 mx-3'>
                        ...
                        <div className='col-span-4'>
                          <div className='relative aspect-[8/5] overflow-hidden rounded-md p-6'>
                            ...
                            <div className='relative z-20 flex flex-col justify-center'>
                              <h4 className='w-3/5 font-semibold'>Stay Ahead with Our New Tech</h4>
                              <div className='mt-8'>
                                <p className='mb-3'>
                        ...
                        <div className='col-span-4'>
                          <div className='relative aspect-[8/5] overflow-hidden rounded-md p-6'>
                            ...
                            <div className='relative z-20 flex h-full flex-col justify-center'>
                              <h4 className='w-3/5 font-semibold'>Check Out for new Speakers</h4>
                              <div className='mt-8'>
                                <p className='mb-3'>
                                  from: <span className='text-lg font-semibold text-primary dark:text-white'>$15</span>
                                </p>
