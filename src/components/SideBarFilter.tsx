...
const locations = ["New York", "Canada", "Bangladesh", "Indonesia", "San Francisco"]
        ...
        <div className='grid grid-cols-2 gap-4'>
          {gender.map((item) => (
            <button
              ...
              className={`rounded-lg py-4 ${activeGender === item ? "bg-primary text-white" : "bg-gray"}`}
            >
              {item}
            </button>
          ))}
        ...
        <div className='grid grid-cols-2 gap-4'>
          {locations.map((item) => (
            <button
              ...
              className={`rounded-lg py-4 ${activeLocation === item ? "bg-primary text-white" : "bg-gray"}`}
            >
              {item}
            </button>
          ))}
