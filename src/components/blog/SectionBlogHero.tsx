...
const SectionBlogHero: FC<SectionBlogHeroProps> = ({ coverImage, title, date, tag }) => {
  return (
    <div className='mb-10'>
      <div className='relative aspect-[16/7]'>
        <img src={coverImage} alt='cover image' className='object-cover h-full w-full' />
        <div className='absolute bottom-0 p-16 xl:w-2/3'>
          <span className='inline-block bg-black px-2 py-1 text-sm text-white'>{tag}</span>
