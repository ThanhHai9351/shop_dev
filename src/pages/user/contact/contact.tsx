...
const ContactPage = () => {
  const breadcrumbItems = [{ title: <ButtonLink href='/'>Home</ButtonLink> }, { title: "About" }]
  return (
    <main>
          ...
          <div className='flex flex-col lg:flex-row lg:gap-16'>
            <div className='relative basis-1/2'>
              <div className='sticky top-0 aspect-video overflow-hidden rounded-md bg-neutral-300 lg:aspect-square'>
                <img src={about} alt='about us' className='object-cover h-full' sizes='100%' />
              </div>
            </div>
            <div className='basis-1/2'>
              <div className='mb-16'>
                <span className='mb-2 text-xs uppercase'>About</span>
                <h2 className='mb-6 text-xl font-semibold lg:text-3xl'>Hi, we are stockmart</h2>
                <p className='mb-4 lg:text-xl'>
                  ...
                  back with the sole ambition of setting new standards in quality and reliability — by forging products
                  that feel personal.
                </p>
                <p className='mb-6 lg:text-xl'>
                  ...
                  Studying your needs deeply, we strive to engineer products that you can feel proud of — to make them
                  your companions for everyday days and hours.
                </p>
                <div className='flex items-center justify-between'>
                  <div className='flex items-center gap-2'>
                    <div className='relative aspect-square size-12 overflow-hidden rounded-full bg-neutral-300 lg:size-16'>
                      <img src={founder} alt='founder' className='object-cover h-full' sizes='100%' />
                    </div>
                  ...
                  <div>
                    <span className='relative inline-block aspect-video h-14 text-neutral-400'>
                      <img src={signature} alt='founder' className='object-cover h-full' sizes='100%' />
                    </span>
                  </div>
                </div>
              </div>
