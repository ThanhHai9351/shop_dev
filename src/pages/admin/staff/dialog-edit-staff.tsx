...
export default function DialogEditStaff({staff,fetchStaffs}:{staff: IUser,fetchStaffs:()=>{}}) {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    const dataStaff = { ...values,internalId: staff.internalId ,id: staff.id,userType: "Staff", operationalRole: "Manager" }
    try {
      const resCreate = await authorizedAxiosInstance.patch(`${configs.host}/users`, dataStaff)
