...
import FormforgotPassword from "@/pages/auth/forgot-password/form-forgot-password"
        ...
        <div className='lg:p-8 h-screen flex items-center justify-center'>
          <div className='mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]'>
            ...
            <div className='flex flex-col space-y-2 text-center'>
              <h1 className='text-2xl font-semibold tracking-tight'>Fotgot Password</h1>
              <p className='text-sm text-muted-foreground'>Enter your email below to access.</p>
            </div>
            <FormforgotPassword />
            <div className='flex flex-col space-y-2 text-center'>
              <p className='text-sm text-muted-foreground'>
                Do have an account? <Link to='/account/login' className="font-bold text-black">Login</Link>
              </p>
            </div>
          </div>
        </div>
