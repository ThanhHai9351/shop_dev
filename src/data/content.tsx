...
import { Ri24HoursLine, RiExchangeDollarLine, RiToolsFill } from "react-icons/ri"
import phoneheader from "@/images/Group_103-1.webp"
import headphonesheader from "@/images/Group_105.webp"
import watchheader from "@/images/Group_106.webp"
import gamingheader from "@/images/Group_157.webp"
import slider_hp from "@/images/new_arrival/Slider_1.webp"
import slider_pc from "@/images/new_arrival/slider_laptop.webp"
import slider_watch from "@/images/new_arrival/Slider_watch.webp"
import ae from "@/images/payments/american-express-svgrepo-com.svg"
import dc from "@/images/payments/diners-club-svgrepo-com.svg"
import dic from "@/images/payments/discover-svgrepo-com.svg"
import mc from "@/images/payments/mastercard-svgrepo-com.svg"
import pp from "@/images/payments/paypal-svgrepo-com.svg"
import visa from "@/images/payments/visa-logo-svgrepo-com.svg"
...
export const newArrivalsData = [
  {
    ...
    content: "Cutting-edge electronics that take you to the forefront of innovation and tech",
    image: slider_hp,
    href: "/collections/headphones",
  },
  {
    title: "Experience the Future with Our New Tech Arrivals",
    content: "Latest tech arrivals to embark on an exciting digital journey today.",
    image: slider_pc,
    href: "/collections/laptops",
  },
  {
...
export const products = [
  ...
  },
  {
    ...
    overview: "Experience FIFA 23 and bring The World's Game to the pitch, with HyperMotion2 Technology.",
  },
  {
...
export const productsSection = {
  ...
  description: "We have a buch of collections for you! Lets explore and find your dream shoes, make it happen",
}
...
const prices = ["Price", "Below $100", "Below $200", "Below $300", "Below $400"]
...
export const newsletter = {
  ...
  description: "Drop your email below and start receiving the best offers from HotKicks",
}

export const shoeSizes = ["EU36", "EU37", "EU38", "EU39", "EU40", "EU41", "EU42", "EU43", "EU44"]
...
const demoBlogData = {
  ...
  sectionFour: {
    title: "What are the best practices for drying sneakers without causing damage?",
    description:
  ...
  sectionFive: [
    ...
    {
      title: "What special care should be taken to extend the lifespan of sneakers?",
      description:
        "Tincidunt nunc pulvinar sapien et ligula. Sed blandit libero volutpat sed cras ornare arcu dui vivamus. Aliquet bibendum enim facilisis gravida neque convallis a cras. Molestie nunc non blandit massa enim nec dui nunc.",
    },
  ],
...
export const blogs: BlogType[] = [
  {
    ...
    brief: "Lorem ipsum dolor sit amet, lormol amenrtol consectetur adipiscing elit, sed do eiusmod tempor.",
    date: "October 2, 2022",
    coverImage:
  ...
  {
    title: "The Influence of Sneaker Collaborations: From Athletes to Designers",
    brief: "Lorem ipsum dolor sit amet, lormol amenrtol consectetur adipiscing elit, sed do eiusmod tempor.",
    date: "October 2, 2022",
    coverImage:
  ...
  {
    title: "Sneaker Collecting 101: Building and Organizing Your Sneaker Collection",
    brief: "Lorem ipsum dolor sit amet, lormol amenrtol consectetur adipiscing elit, sed do eiusmod tempor.",
    date: "October 2, 2022",
    coverImage:
  ...
  {
    title: "Exploring Limited Edition Sneaker Drops: How to Cop Exclusive Releases",
    brief: "Lorem ipsum dolor sit amet, lormol amenrtol consectetur adipiscing elit, sed do eiusmod tempor.",
    date: "October 2, 2022",
    coverImage:
